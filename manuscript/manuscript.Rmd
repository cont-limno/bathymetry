...
\begin{figure}[H]
  ...
  \end{center}
  \caption{Map of study lakes showing A) lake maximum depth measurements, B) cross-section shape class, and C) reservoir classification. The distribution of lake depths from panel A is reported in Figure S4.}\label{fig2}
\end{figure}
