...
\begin{table}
\caption{Summary of lake characteristics for the present study (and for lakes in the contiguous United States from <LAGOSUS-Depth citation>). Predictor variables for computing random forest offsets (Eq ) are printed in bold face. Dashes (-) indicate an identical sample size among this study and that of the contiguous United States.} \label{table1}
\centering
