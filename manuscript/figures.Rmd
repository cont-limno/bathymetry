...
```{r lgnemanual-vs-bathy-depth, fig.cap="Comparison between reported depth and depth calculated from bathymetry surfaces.", warning=FALSE, echo = FALSE, eval=TRUE, out.extra=''}
# see 00_qa.Rmd
...
```{r metric_correlations, fig.cap = "Pearson correlation coefficients of map-derived metrics against inlake slope and deepest point distance metrics.", warning=FALSE, echo = FALSE, eval=TRUE, out.extra=''}
knitr::include_graphics("../figures/metric_correlations-1.pdf")
```

\captionsetup[figure]{name=Table}
\captionsetup[figure]{labelformat=empty}
```{r depth_model_metrics, fig.cap = "Table 2: Model fit and predictive accuarcy metrics for all combinations of true and proxy slopes and distances. ", warning=FALSE, echo = FALSE, eval=TRUE, out.extra=''}
...
```{r contrasts, fig.cap = "Lake characteristics by categorical variables.", warning=FALSE, echo = FALSE, eval=TRUE}
