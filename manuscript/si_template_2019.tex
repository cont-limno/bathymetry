...
\title{Supporting Information for "Imperfect slope measurements drive overestimation in standard cone model of lake depth"}
%
...
\begin{figure}
      ...
      \end{center}
      \caption{Comparison between in-lake and nearshore slopes in concave and convex lakes of the same size and max depth. Categories are quantile bins ($<$ 25\%, 25-50\%, 50-75\%, and 75-100\%).}\label{figS5}
\end{figure}
\clearpage
