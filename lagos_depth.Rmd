...
gg_hypso_ct + theme(plot.title = element_blank())
...
```{r gg-rayshader-concave, eval=TRUE}
...
```{r gg-rayshader-convex, eval=TRUE}
...
```{r get-hypso-normalized, eval=TRUE, fig.height = 4}
...
```{r compare-slopes, eval=TRUE, fig.height = 4}
