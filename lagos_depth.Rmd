...
if(!(file.exists("data/elevatr/pickerel_lake.gri") & 
     file.exists("data/elevatr/long_pond.gri"))){
  elev <- get_elev_raster(rsub1, 13)
  raster::writeRaster(elev, paste0("data/elevatr/", names(rsub1)))
  
  elev <- get_elev_raster(rsub2, 13)
  raster::writeRaster(elev, paste0("data/elevatr/", names(rsub2)))
}
elev1 <- raster::raster("data/elevatr/pickerel_lake.gri")
elev2 <- raster::raster("data/elevatr/long_pond.gri")
