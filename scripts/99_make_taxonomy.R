...
taxonomy_key <- bind_rows(
  ...
  c(col_name = "inlake_slope", description = "slope of the lake bottom assuming a straight line from the shore to the deepest point of the lake in units of depth change in meters per meter distance"),
