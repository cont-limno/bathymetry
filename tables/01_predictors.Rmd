...
dt[
  dt$variable %in% c("dist_deepest", "dist_viscenter", 
                     "inlake_slope", "buffer_slope"), 2:5] <- 
  dt[
  dt$variable %in% c("dist_deepest", "dist_viscenter", 
                     "inlake_slope", "buffer_slope"), 2:5] %>%
...
dt_md <- dt
dt_md$Variable[!stringr::str_detect(dt_md$Variable, "slope|Distance|depth")] <- 
  paste0("**", 
         dt_md$Variable[!stringr::str_detect(dt_md$Variable, "slope|Distance|depth")],
         "**") 
...
# bold Eq 2 predictor variables
dt$Variable[!stringr::str_detect(dt$Variable, "slope|Distance|depth")] <- 
  paste0("\\textbf{", 
         dt$Variable[!stringr::str_detect(dt$Variable, "slope|Distance|depth")],
         "}") 
