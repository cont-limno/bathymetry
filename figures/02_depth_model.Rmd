...
```{r depth_model_metrics, echo=FALSE, message=FALSE, eval=TRUE, warning=FALSE, results='hide', fig.height=2.8, fig.width=4.2}
...
```{r 02_depth_model_importance, echo=FALSE, message=FALSE, eval=TRUE, warning=FALSE, results='hide', fig.height=3.5, fig.width=8}
...
gg_shape <- cowplot::plot_grid(gg_shape[[1]], 
          cowplot::plot_grid(
            ...
            cowplot::plot_grid(gg_shape[[3]], gg_shape[[4]], 
                               rel_widths = c(1, 0.85)), 
            leg, 
            nrow = 3, rel_heights = c(0.85, 1, 0.15)), 
