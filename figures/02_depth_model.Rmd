...
jsta::pdf_table(dt_metrics, "../tables/depth_model_metrics-1.pdf")
```
...
ggplot(data = dt) + 
  ...
  facet_wrap(~ model) + 
    theme(legend.position = "none",
        plot.margin = unit(c(1.5,1.5,0.2,0.2), "cm"))
grid::grid.text(unit(0.93, "npc"), 0.32, 
                label = 'proxy slope', rot = 270) # bottom right
grid::grid.text(unit(0.93, "npc"), 0.65, 
                label = 'true slope', rot = 270) # top right
grid::grid.text(unit(0.7, "npc"), 0.89, 
                label = 'proxy distance') # right
grid::grid.text(unit(0.3, "npc"), 0.89, 
                label = 'true distance') # left
