...
```{r slope-compare, echo=FALSE, message=FALSE, eval=FALSE, warning=FALSE, results='hide', fig.height=3.5}
...
```{r 01_slope_compare, echo=FALSE, message=FALSE, eval=TRUE, warning=FALSE, results='hide', fig.width=6.2, fig.height=5.3}
...
gg_slope_alternative <- function(nearshore_var, inlake_var, dt) {
  ...
  res <-  ggplot(data = dt) +
    ...
    labs(color = "") +
    theme_opts +
    theme(axis.title = element_text(family = "mono", size = 8))
...
gg_slope_list[[5]] <- gg_slope_list[[5]] +
  theme(axis.title.x = element_text(face = "bold"))

gg_slope_list[c(1:5)] <- lapply(
  gg_slope_list[c(1:5)], function(x) x +
    theme(
